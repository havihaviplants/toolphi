...
export default function CarLoanRepaymentsCalculator() {
  ...
  return (
    <div>
      ...
      <p style={{ color: "#555", marginBottom: 16 }}>
        Calculate car loan repayments across monthly, fortnightly, or weekly schedules.
      </p>
        ...
        >
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <div style={{ fontSize: 12, color: "#666" }}>
              Assumes a fixed-rate amortizing car loan.
            </div>
          </div>
        </div>
      )}
