...
export default function UsdaFarmLoanPaymentCalculator() {
  ...
  return (
    <div>
      <p style={{ fontSize: 14, color: "#555", marginBottom: 14 }}>
        Estimate USDA farm loan payments using a standard amortization formula.
        This provides a principal + interest estimate (fees, insurance, and
      ...
      {result && (
        ...
        >
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: "#555" }}>
            Tip: If you know your USDA loan includes fees or closing costs, add
            them into the loan amount for a rough all-in estimate.
          </div>
        </div>
      )}
    </div>
