...
export default function USDAFarmLoanMonthlyPaymentEstimator() {
  ...
  return (
    <div>
      <p style={{ fontSize: 14, color: "#555", marginBottom: 14 }}>
        A fast estimator for <strong>USDA/FSA-style farm loan</strong> monthly
        payments. Enter a loan amount, APR, and term to estimate principal +
        interest payments. Use the rate range table to see how payments change
        if APR shifts by about ±1%.
      </p>
      ...
      {result && (
        <div style={summaryBox}>
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: "#555" }}>
            Tip: USDA/FSA program terms and fees may vary. This estimate is
      ...
      <ul>
        ...
        <li>Principal + interest only (fees/taxes/insurance excluded)</li>
        <li>Program fees, escrow, and eligibility rules are not modeled</li>
        <li>Lender rounding may cause small differences</li>
      </ul>

      <h3>Frequently asked questions</h3>
      <p>
        <strong>Is this an official USDA or FSA tool?</strong>
        <br />
        No. It’s an independent estimator using standard loan math. Official
        program documents and lender disclosures may differ.
      </p>

      <p>
        <strong>Why might my actual payment be different?</strong>
        <br />
        Fees, escrow, insurance, and program-specific terms can change the
        payment. This estimate is principal + interest only.
      </p>

      <p>
        <strong>How can I reduce my monthly payment?</strong>
        <br />
        A longer term may reduce payment but usually increases total interest.
