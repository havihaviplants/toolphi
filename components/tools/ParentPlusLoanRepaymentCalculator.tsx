...
export default function ParentPlusLoanRepaymentCalculator() {
  ...
  return (
    <div>
      ...
      <p style={{ color: "#555", marginBottom: 16 }}>
        Estimate Parent PLUS loan repayment amounts for fixed-rate schedules.
      </p>
        ...
        >
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <div style={{ fontSize: 12, color: "#666" }}>
              Assumes a fixed-rate amortizing Parent PLUS loan.
            </div>
          </div>
        </div>
      )}
