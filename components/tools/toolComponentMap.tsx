...
import CrossBorderPaymentExchangeRateCalculator from "./CrossBorderPaymentExchangeRateCalculator";
...
import RefundRejectionLossCalculator from "./RefundRejectionLossCalculator";
import RefundCancellationCostCalculator from "./RefundCancellationCostCalculator";
...
import ClimateImpactInvestmentROICalculator from "./ClimateImpactInvestmentROICalculator";
...
import HeatingOilPricePerGallonMonthlyBillCalculator from "./HeatingOilPricePerGallonMonthlyBillCalculator";
import HeatingOilAnnualCostEstimatorWinterSeason from "./HeatingOilAnnualCostEstimatorWinterSeason";
...
import AgriculturalLoanPaymentCalculator from "./AgriculturalLoanPaymentCalculator";
import AgLoanPaymentCalculator from "./AgLoanPaymentCalculator";
...
import FarmEquipmentLoanPaymentCalculator from "./FarmEquipmentLoanPaymentCalculator";
...
import USDAFarmLoanMonthlyPaymentEstimator from "./USDAFarmLoanMonthlyPaymentEstimator";
import USDAFarmLoanAmortizationCalculator from "./USDAFarmLoanAmortizationCalculator";
import FarmLandLoanPaymentCalculator from "./FarmLandLoanPaymentCalculator";
import FarmlandLoanAmortizationCalculator from "./FarmlandLoanAmortizationCalculator";
import FarmOperatingCostCalculator from "./FarmOperatingCostCalculator";
import AgriculturalLandLoanCalculator from "./AgriculturalLandLoanCalculator";
import RuralLandLoanCalculator from "./RuralLandLoanCalculator";
import FarmMortgageCalculator from "./FarmMortgageCalculator";
import FarmLandLoanInterestCalculator from "./FarmLandLoanInterestCalculator";
import AgriculturalEquipmentLoanCalculator from "./AgriculturalEquipmentLoanCalculator";
import FarmMachineryLoanCalculator from "./FarmMachineryLoanCalculator";
import AgriculturalEquipmentFinancingCalculator from "./AgriculturalEquipmentFinancingCalculator";
import FarmEquipmentFinancingCalculator from "./FarmEquipmentFinancingCalculator";
import FarmEquipmentLoanInterestCalculator from "./FarmEquipmentLoanInterestCalculator";
...
import IsBuyingFarmlandWorthItCalculator from "./IsBuyingFarmlandWorthItCalculator";
...
import AgriculturalEquipmentLeaseVsLoanCalculator from "./AgriculturalEquipmentLeaseVsLoanCalculator";
import TractorLeaseVsBuyCalculator from "./TractorLeaseVsBuyCalculator";
import EquipmentLeaseAprEquivalentCalculator from "./EquipmentLeaseAprEquivalentCalculator";
...
import InterestRateIncreaseImpactOnFarmLoan from "./InterestRateIncreaseImpactOnFarmLoan";
import CropPriceDropImpactCalculator from "./CropPriceDropImpactCalculator";
...
import InputCostIncreaseBreakEvenCalculator from "./InputCostIncreaseBreakEvenCalculator";
import CostInflationBreakEvenPriceCalculator from "./CostInflationBreakEvenPriceCalculator";
import UnitCostIncreaseBreakEvenYieldCalculator from "./UnitCostIncreaseBreakEvenYieldCalculator";
...
import GrossMarginCompressionCalculator from "./GrossMarginCompressionCalculator";
...
import PaymentFeeImpactOnProfitCalculator from "./PaymentFeeImpactOnProfitCalculator";
import PaymentFeeBreakEvenCalculator from "./PaymentFeeBreakEvenCalculator";
import PaymentFeeRateCalculator from "./PaymentFeeRateCalculator";
import PaymentFeeStressTestCalculator from "./PaymentFeeStressTestCalculator";
import PaymentFeeVsPriceIncreaseCalculator from "./PaymentFeeVsPriceIncreaseCalculator";
import OnlinePaymentFeeComparisonCalculator from "./OnlinePaymentFeeComparisonCalculator";
import OnlinePaymentMonthlyFeeCalculator from "./OnlinePaymentMonthlyFeeCalculator";
import CreditCardVsAchPaymentFeeCalculator from "./CreditCardVsAchPaymentFeeCalculator";
import OnlinePaymentFixedVsPercentageFeeCalculator from "./OnlinePaymentFixedVsPercentageFeeCalculator";
import InternationalOnlinePaymentFeeCalculator from "./InternationalOnlinePaymentFeeCalculator";
...
import OnlinePaymentProviderSwitchingCostCalculator from "./OnlinePaymentProviderSwitchingCostCalculator";
import OnlinePaymentFeeStressTestCalculator from "./OnlinePaymentFeeStressTestCalculator";
...
const toolComponentMap: Record<string, ComponentType> = {
  ...
  "cross-border-payment-exchange-rate-calculator": CrossBorderPaymentExchangeRateCalculator,
  ...
  "refund-rejection-loss-calculator": RefundRejectionLossCalculator,
  "refund-cancellation-cost-calculator": RefundCancellationCostCalculator,
  ...
  "climate-impact-investment-roi-calculator": ClimateImpactInvestmentROICalculator,
  ...
  "heating-oil-price-per-gallon-monthly-bill-calculator": HeatingOilPricePerGallonMonthlyBillCalculator,
  "heating-oil-annual-cost-estimator-winter-season": HeatingOilAnnualCostEstimatorWinterSeason,
  ...
  "ag-loan-payment-calculator": AgLoanPaymentCalculator,
  ...
  "usda-farm-loan-monthly-payment-estimator": USDAFarmLoanMonthlyPaymentEstimator,
  "usda-farm-loan-amortization-calculator": USDAFarmLoanAmortizationCalculator,
  "farm-land-loan-payment-calculator": FarmLandLoanPaymentCalculator,
  "farmland-loan-amortization-calculator": FarmlandLoanAmortizationCalculator,
  "farm-operating-cost-calculator": FarmOperatingCostCalculator,
  "agricultural-land-loan-calculator": AgriculturalLandLoanCalculator,
  "rural-land-loan-calculator": RuralLandLoanCalculator,
  "farm-mortgage-calculator": FarmMortgageCalculator,
  "farm-land-loan-interest-calculator": FarmLandLoanInterestCalculator,
  "agricultural-equipment-loan-calculator": AgriculturalEquipmentLoanCalculator,
  "farm-machinery-loan-calculator": FarmMachineryLoanCalculator,
  "agricultural-equipment-financing-calculator": AgriculturalEquipmentFinancingCalculator,
  "farm-equipment-financing-calculator": FarmEquipmentFinancingCalculator,
  ...
  "is-buying-farmland-worth-it-calculator": IsBuyingFarmlandWorthItCalculator,
  ...
  "agricultural-equipment-lease-vs-loan-calculator": AgriculturalEquipmentLeaseVsLoanCalculator,
  "tractor-lease-vs-buy-calculator": TractorLeaseVsBuyCalculator,
  "equipment-lease-apr-equivalent-calculator": EquipmentLeaseAprEquivalentCalculator,
  ...
  "interest-rate-increase-impact-on-farm-loan": InterestRateIncreaseImpactOnFarmLoan,
  "crop-price-drop-impact-calculator": CropPriceDropImpactCalculator,
  ...
  "input-cost-increase-break-even-calculator": InputCostIncreaseBreakEvenCalculator,
  "cost-inflation-break-even-price-calculator": CostInflationBreakEvenPriceCalculator,
  "unit-cost-increase-break-even-yield-calculator": UnitCostIncreaseBreakEvenYieldCalculator,
  ...
  "gross-margin-compression-calculator": GrossMarginCompressionCalculator,
  ...
  "payment-fee-impact-on-profit-calculator": PaymentFeeImpactOnProfitCalculator,
  "payment-fee-break-even-calculator": PaymentFeeBreakEvenCalculator,
  "payment-fee-rate-calculator": PaymentFeeRateCalculator,
  "payment-fee-stress-test-calculator": PaymentFeeStressTestCalculator,
  "payment-fee-vs-price-increase-calculator": PaymentFeeVsPriceIncreaseCalculator,
  "online-payment-fee-comparison-calculator": OnlinePaymentFeeComparisonCalculator,
  "online-payment-monthly-fee-calculator": OnlinePaymentMonthlyFeeCalculator,
  "credit-card-vs-ach-payment-fee-calculator": CreditCardVsAchPaymentFeeCalculator,
  "online-payment-fixed-vs-percentage-fee-calculator": OnlinePaymentFixedVsPercentageFeeCalculator,
  "international-online-payment-fee-calculator": InternationalOnlinePaymentFeeCalculator,
  ...
  "online-payment-provider-switching-cost-calculator": OnlinePaymentProviderSwitchingCostCalculator,
  "online-payment-fee-stress-test-calculator": OnlinePaymentFeeStressTestCalculator,
