...
export default function HomeLoanRepaymentsCalculator() {
  ...
  const handleCalculate = () => {
    ...
    // Standard amortizing loan payment per period
  ...
  return (
    <div>
      ...
      <p style={{ color: "#555", marginBottom: 16 }}>
        Calculate repayments for a home loan across monthly, fortnightly, or weekly
        schedules.
      </p>
      ...
      <div style={{ display: "grid", gap: 12, marginBottom: 16 }}>
        ...
        <label style={{ fontSize: 14 }}>
          ...
          >
            ...
            <option value="fortnightly">Fortnightly (26 / year)</option>
      ...
      {result && (
        ...
        >
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <div style={{ fontSize: 14 }}>
              <strong>Total paid:</strong> {formatCurrency(result.totalPayment)}
            </div>
            <div style={{ fontSize: 14 }}>
            ...
            <div style={{ fontSize: 12, color: "#666" }}>
              Assumes a standard amortizing loan with fixed interest rate.
            </div>
          </div>
        </div>
      )}
