...
export default function UsdaLandLoanPaymentCalculator() {
  ...
  return (
    <div>
      <p style={{ fontSize: 14, color: "#555", marginBottom: 14 }}>
        Estimate USDA land loan payments using a standard amortization formula.
        This is a principal + interest estimate and does not include fees,
        closing costs, or taxes.
      </p>
      ...
      <div style={{ display: "grid", gap: 14, marginBottom: 16 }}>
        <label>
          ...
          <div style={{ fontSize: 12, color: "#777" }}>
            Total amount borrowed to purchase land
          </div>
          <input
            type="text"
            value={loanAmount}
      ...
      {result && (
        ...
        >
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: "#555" }}>
            Tip: If you have an estimate for closing costs, you can add it into
            the loan amount to approximate an all-in loan size.
          </div>
        </div>
      )}
    </div>
